...
import com.dhb.gts.javacourse.fluent.dao.base.TConfirmLogBaseDao;
import com.dhb.gts.javacourse.fluent.dao.intf.TConfirmLogDao;
import org.springframework.stereotype.Repository;

/**
 * TConfirmLogDaoImpl: 数据操作接口实现
 *
 * 这只是一个减少手工创建的模板文件
