package com.dhb.kmq.v2.demo;

import com.dhb.kmq.v2.core.KmqBroker;
import com.dhb.kmq.v2.core.KmqConsumer;
import com.dhb.kmq.v2.core.KmqMessage;
import com.dhb.kmq.v2.core.KmqProducer;
	...
	public static void main(String[] args) {
		...
		new Thread(() -> {
			while (flag[0]) {
				...
				if (null != message) {
					System.out.println("consumer msg:" + message.getBody());
				}
			}
